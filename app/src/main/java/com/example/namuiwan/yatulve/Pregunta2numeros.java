...
public class Pregunta2numeros extends AppCompatActivity implements View.OnClickListener {
    ...
    MediaPlayer correcto,incorrecto,serpiente, sonido, pregunta3, pregunta2,num1,num2,num3,num4,num5,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pregunta2numeros);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode==event.KEYCODE_BACK) {
            Intent intent = new Intent(Pregunta2numeros.this, Habilidadesnew.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.imgParlanteve:
                Toast.makeText(Pregunta2numeros.this, "¿Cual es el número 4...?", Toast.LENGTH_SHORT).show();
                pregunta2.start();
                break;
            case R.id.imgUno:
                puntos = puntos - 1;
            ...
            case R.id.imgCuatro:
                ...
                Toast.makeText(Pregunta2numeros.this, "Cual es el 5", Toast.LENGTH_SHORT).show();
                Intent intent1 = new Intent(Pregunta2numeros.this, Pregunta3numeros.class);
                pregunta3.start();
                //hacerSonarNumero(pregunta3);
            ...
            /*case R.id.imageView4:
                Toast.makeText(Pregunta2numeros.this, "numeros...?", Toast.LENGTH_SHORT).show();
